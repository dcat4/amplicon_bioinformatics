...
lca.mock.exp.c1 <- compare_results(exp.mock, lca.mock.mapped, table.names[-c(1:2)])
```
...
lca.mock.exp.c2 <- plot_results(exp.mock, lca.mock.mapped, table.names[-c(1:2)])
```
